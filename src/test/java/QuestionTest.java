...
public class QuestionTest extends BaseTest {
    ...
    public QuestionTest(int arrowNumber, String arrowText) {
    ...
    public void testQuestionsAboutImportant() {
        ...
        questionsAboutImportant.clickArrow(arrowNumber);
        String firstArrowText = questionsAboutImportant.getArrowText(arrowNumber);
        assertTrue(firstArrowText.contains(arrowText));
    }
